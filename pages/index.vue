<template>
  <main class="overflow-hidden">
    <section id="introduction" class="w-full h-screen overflow-hidden relative reveal reveal-fade-200">
      <nuxt-picture
      ...
      <nuxt-link to="#presentation" class="w-fit inline-block circle bounce border border-black rounded-full">
        <i class="icon icon-arrow arrow text-black text-2xl"></i>
      </nuxt-link>
    </section>

    <section id="presentation" class="p-10 max-w-5xl text-center mx-auto">
      <h1 class="text-h3 text-gray-500 font-semibold mb-5 reveal reveal-bottom-500">CHOISISSEZ VOTRE TYPE DE VÉLO</h1>
      <p class="reveal reveal-bottom-500">Chez N-Bike, la pratique du vélo, quelles que soient les formes, est notre
        passion et
        c’est la raison pour
        laquelle nous mettons autant d’énergie et d’efforts pour concevoir certains des meilleurs vélos au monde. VTT,
        vélos de route, vélos électriques, vélos gravel et de cyclocross et même des vélos de ville ou de trekking. Et
        comme nous souhaitons voir tout le monde heureux, nos gammes contiennent des vélos pour homme et femme, mais
        aussi
        pour adolescents et enfants. Choisissez simplement votre discipline et trouvez le vélo parfait.</p>
    </section>


    <section id="categories" class="max-w-[2000px] mx-auto mt-10">
      <swiper-container
          :breakpoints="{
                        320: {
                          slidesPerView: 1,
          ...
          :auto-height="true"
      >
        <swiper-slide lazy="true" v-for="(category , index) in categoryData" :key="category.id">
          <div class="flex justify-center">
            <category-card
                ...
                :class="`reveal reveal-bottom-${index+1}00`"
            />
          </div>
        </swiper-slide>
      </swiper-container>
    ...
    <section id="guide" class="mt-10 mb-20">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row max-w-6xl mx-auto reveal reveal-right-500">
          <nuxt-picture src="/picture/img16.jpg" class="sm:order-2"
                        :img-attrs="{class: 'w-full h-full object-cover'}"></nuxt-picture>
          <div class="bg-black flex items-center justify-center px-12 py-24">
    ...
    <section id="bike-finder">
      <div class="relative">
        <div class="flex items-center justify-center">
          ...
          <nuxt-picture src="/picture/img3.jpg" class="w-full h-full hidden sm:block reveal reveal-right-400"
                        :img-attrs="{class: 'w-full h-full object-contain'}"></nuxt-picture>
        </div>
        <div
            class="absolute space-y-3 sm:space-y-5 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center reveal reveal-fade-500">
